...
1. Базу данных генерировать из кода или можно создать непосредственно в MS SQL? 
2. Есть ли необходимость заполнить базу тестовыми значениями

1.       Из кода
2.       Да, заполнение сделать отдельно